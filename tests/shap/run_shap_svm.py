...
실행:
  ...
  python tests/shap/run_shap_svm.py --output-dir tests/shap/results/20260519_2000_SVM  (이어하기)
"""
...
def run_shap_svm(data_dir, ml_dir, output_base, run_date=None, output_dir_override=None):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SHAP — One-Class SVM")
    ...
    run_shap_svm(DATA_DIR, ML_DIR, OUTPUT_BASE, run_date=args.run_date, output_dir_override=args.output_dir)